  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pythoneda-artifact-infrastructure-changes-0_0_1a2-for = { pythoneda-base
          , pythoneda-artifact-event-changes
          , pythoneda-artifact-event-infrastructure-changes
          , pythoneda-artifact-changes, pythoneda-infrastructure-base
          , pythoneda-shared-git, python }:
      ...
      in rec {
        packages = rec {
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python38 =
            pythoneda-artifact-infrastructure-changes-0_0_1a2-for {
              pythoneda-base =
          ...
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python39 =
            pythoneda-artifact-infrastructure-changes-0_0_1a2-for {
              pythoneda-base =
          ...
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python310 =
            pythoneda-artifact-infrastructure-changes-0_0_1a2-for {
              pythoneda-base =
        ...
        devShells = rec {
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python38 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-infrastructure-changes-0_0_1a2-python38;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python39;
              python = pkgs.python38;
          ...
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python39 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-infrastructure-changes-0_0_1a2-python39;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python39;
              python = pkgs.python39;
              inherit pkgs nixpkgsRelease;
          ...
          pythoneda-artifact-infrastructure-changes-0_0_1a2-python310 =
            shared.devShell-for {
              package =
                packages.pythoneda-artifact-infrastructure-changes-0_0_1a2-python310;
              pythoneda-base =
                pythoneda-base.packages.${system}.pythoneda-base-latest-python310;
              python = pkgs.python310;
              inherit pkgs nixpkgsRelease;
