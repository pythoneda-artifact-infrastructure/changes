rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[33mhttps://github.com/pythoneda-artifact-infrastructure/changes/tree/$PVERSION\033[0m";
    echo -e " \033[32m| |_) | |_| | |_| | | | (_) | | | |\033[34m  __/\033[35m (_| |\033[36m (_| |\033[34mhttps://github.com/pythoneda-artifact/changes\033[0m";
    ...
    echo -e " \033[32m|_| \033[31mI\033[36mA\033[32m |___/                \033[33mCHANGES                 \033[37mhttps://patreon.com/rydnr\033[0m";
    echo;
    echo " Thank you for using pythoneda-artifact-infrastructure/changes, PythonEDA in general, and for your appreciation of free software.";
    echo;
